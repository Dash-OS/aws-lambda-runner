...
export type LambdaCallbackFunction = (
  error: Error | $Subtype<Error> | null,
  data?: | {|
      statusCode: number,
      headers: {
...
export type LambdaData = mixed;

export type LambdaProxyEvent = {|
  path: string,
  headers: {
    [headerName: string]: string
  },
...
export type LambdaEventObject = LambdaProxyEvent | Object;

export type LambdaContextObject = {|
