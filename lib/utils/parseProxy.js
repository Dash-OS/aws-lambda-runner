...
import type { Lambda$ProxyEvent } from '../types/lambda';
...
const handleParam: {
  DEFAULT: (key: string, value: any, config: Runner$RuntimeConfig) => boolean,
  [key: $Keys<Lambda$ProxyEvent>]: (value: any, config: Runner$RuntimeConfig) => boolean,
} = {
  ...
  // headers will be normalized to lower case
...
export default function<+D: Lambda$ProxyEvent, +C: Runner$RuntimeConfig>(data: D, config: C) {
