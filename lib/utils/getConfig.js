...
const getRuntimeConfig = (config: Runner$Config): Runner$RuntimeConfig =>
  Object.freeze({
    ...
    request: {
      ...
      headers: Object.assign({}, (config.request && config.request.headers) || {}),
      // received queries ?foo=bar&baz=qux
      queries: Object.assign({}, (config.request && config.request.queries) || {}),
      // received parameters /{param1}/{param2}
      params: Object.assign({}, (config.request && config.request.params) || {}),
      // received stage variables
      stage: Object.assign({}, (config.request && config.request.stage) || {}),
    },
